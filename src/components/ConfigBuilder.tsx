    ...
    <>
      <ConsoleSection title="Config Builder">
        <p className="mb-4 text-xs md:text-sm">
          ...
          The download link is hosted on GitHub Pages, so you can share it with teammates.
        </p>
            ...
            <div className="bg-cs-dark border border-cs-green/30 p-4">
              ...
              {!downloadUrl && (
                <p className="mt-3 text-[10px] md:text-xs text-cs-gray">
                  Generate the config to get your download link and exec command.
                </p>
              )}
